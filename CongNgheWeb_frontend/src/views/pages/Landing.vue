        ...
        <div id="home" class="landing-wrapper overflow-hidden">
            ...
            >
                <div class="mx-4 md:mx-8 mt-0 md:mt-4">
                    <h1 class="text-6xl font-bold text-gray-900 line-height-2"><span class="font-light block">BarClub</span>Where everything begins ?</h1>
                    <p class="font-normal text-2xl line-height-3 md:mt-3 text-gray-700">Let's start learning programming with BarClub.</p>
                    <router-link :to="{ name: 'Login' }">
